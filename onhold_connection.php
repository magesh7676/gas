...
$sql = "SELECT * FROM tbl_client WHERE delete_status = 0 and status= 1";
...
<h3 class="text-primary"> On Hold Connections</h3> </div>
<div class="col-md-7 align-self-center">
<ol class="breadcrumb">
<li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
<li class="breadcrumb-item active">On Hold Connections</li>
</ol>
</div>
</div>
