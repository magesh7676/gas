...
$sql = "SELECT * FROM tbl_client WHERE delete_status = 0 and status= 3";
...
<h3 class="text-primary"> Rejected Connection</h3> </div>
<div class="col-md-7 align-self-center">
<ol class="breadcrumb">
<li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
<li class="breadcrumb-item active">Rejected Connection</li>
</ol>
</div>
</div>
...
<a href="edit_connection.php?id=<?php //Rejectedecho $row['id']?>"><button type="button" class="btn btn-xm btn-primary" >Change Status</button></a>
