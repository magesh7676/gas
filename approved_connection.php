...
$sql = "SELECT * FROM tbl_client WHERE delete_status = 0 and status= 2";
...
<h3 class="text-primary"> Approved Connection</h3> </div>
<div class="col-md-7 align-self-center">
<ol class="breadcrumb">
<li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
<li class="breadcrumb-item active">Approved Connection</li>
</ol>
</div>
</div>
