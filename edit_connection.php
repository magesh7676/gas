...
<form class="form-horizontal" method="POST"  id="submitBrandForm" action="php_action/editconnection.php?id=<?php echo $_GET['id'];?>" enctype="multipart/form-data">
 <fieldset>
...
<div class="col-sm-9">
<input type="text" class="form-control" id="name" placeholder=" Name" name="name" autocomplete="off" readonly="" value="<?php  echo$result['name'];?>" />
</div>
</div>
</div>
<!--  Author : Mayuri K. 
...
<div class="col-sm-9">
  <select class="form-control" id="brandName" name="gender" readonly>
...
<div class="col-sm-9">
<input type="text" class="form-control" id="" placeholder="" name="mob_no" autocomplete="off" readonly="" value="<?php  echo$result['mob_no'];?>" />
</div>
</div>
</div>
<div class="form-group">
...
<div class="col-sm-9">
    <input type="text" class="form-control" id="" placeholder="" name="reffering" autocomplete="off" readonly="" value="<?php  echo$result['reffering'];?>" />
...
<div class="col-sm-9">
    <textarea type="text" class="form-control" id="" placeholder="" name="address" autocomplete="off" readonly="" style="height: 150px;"><?php  echo$result['address'];?></textarea>
...
<div class="col-sm-9">
  <select class="form-control" id="brandName" name="connection">
    <option readonly>Select Option</option>
    <option value="1" <?php if($result['status']=="1"){ echo "selected";}?>>On Hold Connections</option>
    <option value="2" <?php if($result['status']=="2"){ echo "selected";}?>>Approved Connections</option>
    <option value="3" <?php if($result['status']=="3"){ echo "selected";}?>>Rejected Connections</option>
